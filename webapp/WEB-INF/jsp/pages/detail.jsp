		...
		<main>
			...
			<div class="row">
				<%-- <div class="col-5 offset-1">
					<div class="row g-0">
						<div class="col-md-4">
							<img src="<%=request.getContextPath()%>/assets/img/radio.jpg"
				...
				<div class="col-3 offset-4">
					...
					<div class="mt-2">
						<p>
							Catégorie :
							<%=article.getCategories().getLibelle()%>
						</p>
					</div>
					<div class="mt-2">
						<p id="meilleurOffre">
							Meilleur offre :
							<%=article.getEnchersMax(article.getNo_article())%>
							par
							<%
					...
					<div class="mt-2">
						<p>
							Retrait :
							<%=article.getUser().getStreet()%>
							<%=article.getUser().getZipCode()%>
							<%=article.getUser().getTown()%>
						</p>
					</div>
					<div class="mt-2">
						<p>
							Vendeur :
							<%=articleVendeur.getUser().getUsername()%>
						</p>
					</div>
					<%
					...
					<form action="" method="post">
						<div class="mt-2">
							<label for="proposition" class="form-label mt-2">Ma
								proposition</label> <input type="number" class="form-control"
								name="proposition" id="proposition"
								value="<%=article.getEnchersMax(article.getNo_article()) + 1%>"
								min="<%=article.getEnchersMax(article.getNo_article()) + 1%>">
							<p>
								Vos Crédits :
								<%=credit%></p>
						</div>
